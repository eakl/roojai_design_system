...
RemixCardStyler resolveDsCardStyle({
  ...
  final variantStyle = switch (variant) {
    DsCardVariant.base => RemixCardStyler().backgroundColor($surfaceDefault()),
    DsCardVariant.alternative => RemixCardStyler().backgroundColor(
      $surfaceAlternative(),
    ),
    DsCardVariant.inverted => RemixCardStyler().backgroundColor(
      $surfaceInverted(),
    ),
...
Color _resolveDsCardForegroundColor(
  BuildContext context,
  DsCardVariant variant,
) {
  return switch (variant) {
    DsCardVariant.inverted => $contentOnBrand.resolve(context),
    DsCardVariant.base ||
    DsCardVariant.alternative ||
    DsCardVariant.elevated ||
    DsCardVariant.bordered => $contentPrimary.resolve(context),
  };
}
