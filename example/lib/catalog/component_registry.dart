...
// NOTE: Every showcase spec below except Button 2 depends on a `ui`
// component that's currently excluded from `ui.dart` (see the NOTE there)
// because it still calls the removed AppTokens/SemanticColors/
// SemanticTypography API and fails to compile. Re-enable these imports and
// registry entries once those components are migrated to the current
// Mix-token system.
